...
public class DragAndDrop2 {
	...
	public void create () {
		...
		skin.add("TOne", new Texture("../core/src/com/dchs/scout/imagesY6RY7W25.png"));

		Image sourceImage = new Image(skin, "TOne");
		sourceImage.setBounds(50, 125, 100, 100);
		stage.addActor(sourceImage);

		Image validTargetImage = new Image(skin, "TOne");
		validTargetImage.setBounds(200, 50, 100, 100);
		stage.addActor(validTargetImage);

		Image invalidTargetImage = new Image(skin, "TOne");
